...
void r_Config_DMAC00_dmac00_init(void)
{
    ...
    PDMA0.DTCT0 = _DMAC_CYCLES_EXECUTED | _DMAC_TRANSFER_SOFTWARE | _DMAC_CHAIN_DISABLE | 
                  _DMAC_TRANSFER_COMPLETION_INTERRUPT_ENABLE | _DMAC_CONTINUOUS_TRANSFER_DISABLE | 
                  _DMAC_RELOAD2_DISABLE | _DMAC_RELOAD1_DISABLE | _DMAC_DESTINATION_FIXED | _DMAC_SOURCE_FIXED | 
                  _DMAC_TRANSFER_DATA_8BITS | _DMAC_SINGLE_TRANSFER;
    PDMA0.DTFR0 = _DMAC_HARDWARE_TRIGGER_DISABLE;
