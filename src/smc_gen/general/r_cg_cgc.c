...
void R_CGC_Create(void)
{
    ...
    WPROTR.PROTCMD0 = _WRITE_PROTECT_COMMAND;
    CLKCTL.CKSC_ARTCAD_CTL = _CGC_RTCA_CLK_DIVIDER_2;
    CLKCTL.CKSC_ARTCAD_CTL = (uint32_t) ~_CGC_RTCA_CLK_DIVIDER_2;
    CLKCTL.CKSC_ARTCAD_CTL = _CGC_RTCA_CLK_DIVIDER_2;
    while (CLKCTL.CKSC_ARTCAD_ACT != _CGC_RTCA_CLK_DIVIDER_2)
    {
        NOP();
    }
    CLKCTL.CKSC_ARTCAD_STPM = _CGC_CKSC_ARTCAD_STPM_DEFAULT_VALUE | _CGC_RTCA_CLK_REQUEST_CONTINUE;
