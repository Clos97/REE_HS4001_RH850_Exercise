...
/* ADCA0 SCAN GROUP 1  END INTERRUPT */
#if defined (__CCRH__)
...
/* ADCA0 SCAN GROUP 2  END INTERRUPT */
#if defined (__CCRH__)
...
/* ADCA0 SCAN GROUP 3  END INTERRUPT */
#if defined (__CCRH__)
...
/* ADCA1 SCAN GROUP 1  END INTERRUPT */
#if defined (__CCRH__)
...
/* ADCA1 SCAN GROUP 2  END INTERRUPT */
#if defined (__CCRH__)
...
/* ADCA1 SCAN GROUP 3  END INTERRUPT */
#if defined (__CCRH__)
