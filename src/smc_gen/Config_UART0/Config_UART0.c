...
void R_Config_UART0_Create(void)
{
    ...
    INTC2.ICRLIN30UR0.UINT16 &= _INT_PRIORITY_LEVEL11;
    RLN30.LWBR = _UART_13_SAMPLING | _UART_PRESCALER_CLOCK_SELECT_2;
    ...
    RLN30.LBFC = _UART_TRANSMISSION_NORMAL | _UART_PARITY_ODD | _UART_STOP_BIT_1 | _UART_LSB | _UART_LENGTH_8;
