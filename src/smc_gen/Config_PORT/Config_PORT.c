...
void R_Config_PORT_Create(void)
{
    ...
    PORT.PDSC0 = _PORT_PDSCn6_SLOW_MODE_SELECT | _PORT_PDSCn10_SLOW_MODE_SELECT;
    PORT.PDSC0 = (uint32_t) ~(_PORT_PDSCn6_SLOW_MODE_SELECT | _PORT_PDSCn10_SLOW_MODE_SELECT);
    PORT.PDSC0 = _PORT_PDSCn6_SLOW_MODE_SELECT | _PORT_PDSCn10_SLOW_MODE_SELECT;
    PORT.PPCMD0 = _WRITE_PROTECT_COMMAND;
    PORT.PODC0 = _PORT_PODCn6_PUSH_PULL | _PORT_PODCn10_PUSH_PULL;
    PORT.PODC0 = (uint32_t) ~(_PORT_PODCn6_PUSH_PULL | _PORT_PODCn10_PUSH_PULL);
    PORT.PODC0 = _PORT_PODCn6_PUSH_PULL | _PORT_PODCn10_PUSH_PULL;
    PORT.PBDC0 = _PORT_PBDCn6_MODE_DISABLED | _PORT_PBDCn10_MODE_DISABLED;
    PORT.P0 = _PORT_Pn6_OUTPUT_LOW | _PORT_Pn10_OUTPUT_LOW;
    PORT.PM0 = _PORT_PM0_DEFAULT_VALUE | _PORT_PMn0_MODE_UNUSED | _PORT_PMn1_MODE_UNUSED | _PORT_PMn2_MODE_UNUSED | 
               _PORT_PMn3_MODE_UNUSED | _PORT_PMn4_MODE_UNUSED | _PORT_PMn5_MODE_UNUSED | _PORT_PMn6_MODE_OUTPUT | 
               _PORT_PMn7_MODE_UNUSED | _PORT_PMn8_MODE_UNUSED | _PORT_PMn9_MODE_UNUSED | _PORT_PMn10_MODE_OUTPUT | 
