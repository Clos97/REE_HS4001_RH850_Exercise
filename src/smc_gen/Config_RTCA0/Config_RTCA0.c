...
void R_Config_RTCA0_Create(void)
{
    ...
    INTC2.ICRTCA0AL.UINT16 &= _INT_PRIORITY_LEVEL1;
    ...
    RTCA0.ALW = _RTC_ALARM_SATURDAY_ENABLE | _RTC_ALARM_FRIDAY_ENABLE | _RTC_ALARM_THURSDAY_ENABLE | 
                _RTC_ALARM_WEDNESDAY_ENABLE | _RTC_ALARM_TUESDAY_ENABLE | _RTC_ALARM_MONDAY_ENABLE | 
                _RTC_ALARM_SUNDAY_ENABLE;
